...
<img src="./3.assets/image-20200711093546398.png" alt="image-20200711093546398" style="zoom:50%;" />

<img src="./3.assets/image-20200711093558709.png" alt="image-20200711093558709" style="zoom:50%;" />
...
<img src="./3.assets/image-20200711102231129.png" alt="image-20200711102231129" style="zoom: 50%;" />
...
s.intern(); // 将该对象放入到常量池。但是调用此方法没有太多的区别，因为已经存在了
String s2 = "1";
...
```java
String s = new String("1");
s.intern(); // 而这里在new的时候已经加入了常量池，所以这里不会有任何反应
String s2 = "1";
System.out.println(s == s2); // false

String s3 = new String("1") + new String("1");
s3.intern(); // 这个地方会往常量池中添加11，但是由于堆中已经有11对象s3,所以常量池中直接就会使用s3这个引用，而不是又新创建一个
String s4 = "11";
System.out.println(s3 == s4); // true
```

<img src="./3.assets/image-20200711145925091.png" alt="image-20200711145925091" style="zoom: 50%;" />
