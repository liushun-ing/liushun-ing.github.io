import{_ as n,o as e,c as a,a as s}from"./app-79248646.js";const o={},i=s(`<h1 id="go-work" tabindex="-1"><a class="header-anchor" href="#go-work" aria-hidden="true">#</a> go.work</h1><p>随着go 1.18版本的正式发布，多模块工作区也被引入（WorkSpaces），多模块工作区能够使开发者能够更容易地同时处理多个模块的工作， 如：方便进行依赖的代码调试(打断点、修改代码)、排查依赖代码 bug 。方便同时进行多个仓库/模块并行开发调试。</p><h2 id="起因" tabindex="-1"><a class="header-anchor" href="#起因" aria-hidden="true">#</a> 起因</h2><p>本地有两个项目，分别是两个 module：example1 和 example2。</p><p>在 example1 的 bar.go 中有如下代码：</p><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code><span class="token keyword">package</span> example1
