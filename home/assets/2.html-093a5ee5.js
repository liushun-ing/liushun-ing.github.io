import{_ as s,o as a,c as t,b as p,t as e,a as n}from"./app-69b48761.js";const o="/home/assets/image-20211006234708474-cd981d41.png",l={},c=n(`<h1 id="小程序部分语法" tabindex="-1"><a class="header-anchor" href="#小程序部分语法" aria-hidden="true">#</a> 小程序部分语法</h1><p>详细教程可以查看黑马编写的文档 <a href="./ref.pdf">黑马文档</a></p><h2 id="公共配置" tabindex="-1"><a class="header-anchor" href="#公共配置" aria-hidden="true">#</a> 公共配置</h2><h3 id="app-json公共配置文件" tabindex="-1"><a class="header-anchor" href="#app-json公共配置文件" aria-hidden="true">#</a> app.json公共配置文件</h3><p>颜色只能是十六进制形式</p><p>其他选择访问https://developers.weixin.qq.com/miniprogram/dev/reference/configuration/app.html#pages</p><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token property">&quot;pages&quot;</span><span class="token operator">:</span><span class="token punctuation">[</span>
