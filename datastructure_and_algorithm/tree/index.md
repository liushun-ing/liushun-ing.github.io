...
<img src="index.assets/image-20220531142818847.png" alt="image-20220531142818847" style="zoom:67%;" />
...
<img src="index.assets/image-20220531143044218.png" alt="image-20220531143044218" style="zoom:80%;" />

**完全二叉树**

高度为h、有n个结点的二叉树，当且仅当其每个结点都与高度为h的满二叉树中编号为1~n的结点一一对应时，称为完全二叉树。

<img src="index.assets/image-20220531143237328.png" alt="image-20220531143237328" style="zoom: 80%;" />
...
<img src="index.assets/image-20220531144043384.png" alt="image-20220531144043384" style="zoom:80%;" />
...
<img src="index.assets/image-20220531144153045.png" alt="image-20220531144153045" style="zoom:80%;" /><img src="index.assets/image-20220531144221660.png" alt="image-20220531144221660" style="zoom:80%;" />
...
<img src="index.assets/image-20220531152523456.png" alt="image-20220531152523456" style="zoom:80%;" />

标志域含义如下：

<img src="index.assets/image-20220531152542330.png" alt="image-20220531152542330" style="zoom:80%;" />
...
<img src="index.assets/image-20220531160120563.png" alt="image-20220531160120563" style="zoom:80%;" />
...
<img src="index.assets/image-20220531170510030.png" alt="image-20220531170510030" style="zoom:80%;" />
...
<img src="index.assets/image-20220531193600792.png" alt="image-20220531193600792" style="zoom: 80%;" />
...
<img src="index.assets/image-20220531193819862.png" alt="image-20220531193819862" style="zoom:80%;" />

<img src="index.assets/image-20220531194228154.png" alt="image-20220531194228154" style="zoom: 67%;" /><img src="index.assets/image-20220531194243567.png" alt="image-20220531194243567" style="zoom: 67%;" />
...
<img src="index.assets/image-20220531200445569.png" alt="image-20220531200445569" style="zoom:80%;" /><img src="index.assets/image-20220531200520155.png" alt="image-20220531200520155" style="zoom:80%;" />

<img src="index.assets/image-20220531200530922.png" alt="image-20220531200530922" style="zoom:80%;" />
...
<img src="index.assets/image-20220531201727811.png" alt="image-20220531201727811" style="zoom:67%;" /><img src="index.assets/image-20220531201744384.png" alt="image-20220531201744384" style="zoom:67%;" /><img src="index.assets/image-20220531201756629.png" alt="image-20220531201756629" style="zoom:67%;" />
...
<img src="index.assets/image-20220531203927440.png" alt="image-20220531203927440" style="zoom:80%;" />
...
<img src="index.assets/image-20220531204813337.png" alt="image-20220531204813337" style="zoom:80%;" />

**2）RR平衡旋转（左单旋转)**。由于在结点A的右孩子(R）的右子树(R)上插入了新结点，A的平衡因子由-1减至-2，导致以A为根的子树失去平衡，需要一次向左的旋转操作。

<img src="index.assets/image-20220531204851801.png" alt="image-20220531204851801" style="zoom:80%;" />

**3）LR平衡旋转(先左后右双旋转)**。由于在A的左孩子(L)的右子树(R)上插入新结点，A的平衡因子由1增至2，导致以A为根的子树失去平衡，需要进行两次旋转操作，先左旋转后右旋转。

<img src="index.assets/image-20220531204941545.png" alt="image-20220531204941545" style="zoom:80%;" />

**4）RL平衡旋转(先右后左双旋转)**。由于在A的右孩子(R)的左子树(L)上插入新结点，A的平衡因子由-1减至-2，导致以A为根的子树失去平衡，需要进行两次旋转操作，先右旋转后左旋转。

<img src="index.assets/image-20220531205019951.png" alt="image-20220531205019951" style="zoom:80%;" />



一个简单的例子

<img src="index.assets/image-20220531205053279.png" alt="image-20220531205053279" style="zoom:80%;" />
...
<img src="index.assets/image-20220531215514623.png" alt="image-20220531215514623" style="zoom:80%;" />
...
<img src="index.assets/image-20220531220135998.png" alt="image-20220531220135998" style="zoom:80%;" />
